...
interface AdminNav extends SectionNavItem {
  perm: string;
}

/** 管理后台布局 + 管理台令牌门控（设置式侧栏，按 IAM 权限渲染导航）。 */
const AdminLayout = () => {
  ...
  const navItems: SectionNavItem[] = allNav
  ...
  return (
    <SectionShell
      ...
      identity={{ name: me.displayName || me.username || t("admin.staff"), sub: me.email, avatarUrl: me.avatarUrl }}
      navItems={navItems}
