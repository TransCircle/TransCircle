    ...
    <div className={styles.appContainer}>
      ...
      >
        ...
        >
          ...
          >
            <a
              href="https://transcircle.org/s/join"
              className={
                styles.ctaPrimary
              }
              target="_blank"
            ...
            <a
              href="https://transcircle.org/s/x-chat"
              className={
                styles.ctaSecondary
              }
              target="_blank"
        ...
        >
          ...
          >
            <li>
              <a
                href="https://github.com/TransCircle/TransCircle"
                className={
                  styles.socialLink
                }
                target="_blank"
            ...
            <li>
              <a
                href="https://x.com/TransCircleOrg"
                className={
                  styles.socialLink
                }
                target="_blank"
            ...
            <li>
              <a
                href="https://bsky.app/profile/TransCircle.org"
                className={
                  styles.socialLink
                }
                target="_blank"
